...
class WilayatesImport implements ToCollection, WithHeadingRow, WithChunkReading
{
    ...
    {
        $unique = fn ($column) =>
            Rule::unique('wilayates', $column)->whereNull('deleted_at');
        ...
        return Validator::make($row, [
           ...
           'code' => __('imports.wilayates.code'),
            'designation_francais'  => __('imports.wilayates.designation_fr'),
            'designation_anglais'    => __('imports.wilayates.designation_en') ,
            'designation_arabe'     =>  __('imports.wilayates.designation_ar'),
        ]);
    }

    /**
     * Insert wilaya into the database.
     */
    protected function insertWilaya(array $row): void
    {
        Wilaya::create([
            'code'             => $row['code'],
