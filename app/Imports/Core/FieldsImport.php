...
class FieldsImport implements ToCollection, WithHeadingRow, WithChunkReading
{
    ...
    protected function getValidator(array $row)
    {
       ...
       [
           'acronym' => __('imports.fields.acronym'),
            'designation_francais'  => __('imports.fields.designation_fr'),
            'designation_anglais'    => __('imports.fields.designation_en') ,
            'designation_arabe'     =>  __('imports.fields.designation_ar'),
        ]
     ...
     */
    protected function insertField(array $row): void
    {
        Field::create([
            'acronym'          => $row['acronym'],
