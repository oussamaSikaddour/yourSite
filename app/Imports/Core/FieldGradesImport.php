...
class FieldGradesImport implements ToCollection, WithHeadingRow, WithChunkReading
{
    ...
    protected function getValidator(array $row)
    {
       ...
       [
           'acronym' => __('imports.field_grades.acronym'),
            'designation_francais'  => __('imports.field_grades.designation_fr'),
            'designation_anglais'    => __('imports.field_grades.designation_en') ,
            'designation_arabe'     =>  __('imports.field_grades.designation_ar'),
        ]);
    }
     ...
     */
    protected function insertFieldGrade(array $row): void
    {
        FieldGrade::create([
            'acronym'          => $row['acronym'],
