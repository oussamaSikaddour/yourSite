...
class DairatesImport implements ToCollection, WithHeadingRow, WithChunkReading
{
    ...
    protected ?int $wilayaId=null;


        public function __construct($wilayaId)
    {
    ...
    {
        $unique = fn ($column) =>
            Rule::unique('dairates', $column)->whereNull('deleted_at');
        ...
        return Validator::make($row, [
           ...
           'code' => __('imports.dairates.code'),
            'designation_francais'  => __('imports.dairates.designation_fr'),
            'designation_anglais'    => __('imports.dairates.designation_en') ,
            'designation_arabe'     =>  __('imports.dairates.designation_ar'),
        ]);
    }
     ...
     */
    protected function insertDaira(array $row): void
    {
        Daira::create([
            'code'          => $row['code'],
