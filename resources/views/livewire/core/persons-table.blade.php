<div class="table__container" x-on:update-persons-table.window="$wire.$refresh()">
    <div class="table__header">
        ...
        <div class="table__header__actions">
            @canany(['super-admin-access', 'admin-access','social-admin-access'])
            ...
            <form class="form">
                ...
                <div class="row">
                    <x-core.form.input
                        ...
                        :label="__('tables.persons.employee_number')"
                        type="text"
                        html_id="p-EmployeeUT"
                        role="filter"
                    />
                </div>
                ...
                <div class="row">
                 ...
                 htmlId="p-BankAcronymUT"
                 model="bankAcronym"
                 :label="__('tables.persons.bank_acronym')"
                 :data="$banksOptions"
                 type="filter" />
                    ...
                    <x-core.form.input
                        model="bankAccount"
                        :label="__('tables.persons.bank_account')"
                        type="text"
                        html_id="p-BankAccountUT"
                        role="filter"
                    />
                ...
                <thead>
                    <tr>
                        ...
                        <x-core.table.sortable-th
                            wire:key="P-TH-2"
                            model="full_name_fr"
                            :label="__('tables.persons.full_name_fr')"
                            :$sortDirection :$sortBy
                        />
                        ...
                        <x-core.table.sortable-th
                            wire:key="P-TH-11"
                            model="full_name_ar"
                            :label="__('tables.persons.full_name_ar')"
                            :$sortDirection :$sortBy
                        />
                        ...
                        {{-- ✅ NEW: Bank columns (sortable) --}}
                        <x-core.table.sortable-th
                            wire:key="P-TH-BANK-ACR"
                            model="bank_acronym"
                            :label="__('tables.persons.bank_acronym')"
                            :$sortDirection :$sortBy
                        />
                        ...
                        <x-core.table.sortable-th
                            wire:key="P-TH-13"
                            model="social_number"
                            :label="__('tables.persons.social_number')"
                            :$sortDirection :$sortBy
                        />
                        ...
                        <x-core.table.sortable-th
                            wire:key="P-TH-4"
                            model="created_at"
                            :label="__('tables.persons.registration_date')"
                            :$sortDirection :$sortBy
                        />
                        ...
                        <x-core.table.sortable-th
                            wire:key="P-TH-6"
                            model="card_number"
                            :label="__('tables.persons.card_number')"
                            :$sortDirection :$sortBy
                        />
                        ...
                        <x-core.table.sortable-th
                            wire:key="P-TH-7"
                            model="birth_date"
                            :label="__('tables.persons.birth_date')"
                            :$sortDirection :$sortBy
                        />

                        <x-core.table.sortable-th
                            wire:key="P-TH-8"
                            model="birth_place_fr"
                            :label="__('tables.persons.birth_place_fr')"
                            :$sortDirection :$sortBy
                        />

                        <x-core.table.sortable-th
                            wire:key="P-TH-9"
                            model="birth_place_ar"
                            :label="__('tables.persons.birth_place_ar')"
                            :$sortDirection :$sortBy
                        />

                        <x-core.table.sortable-th
                            wire:key="P-TH-10"
                            model="birth_place_en"
                            :label="__('tables.persons.birth_place_en')"
                            :$sortDirection :$sortBy
                        />
                    </tr>
                </thead>
                        ...
                        <tr wire:key="person-{{ $p->id }}">
                            <td>
                                <x-core.button
                                    ...
                                    rounded=true
                                    hasTooltip=true
                                    :tooltip="__('toolTips.person.delete')"
                                />
                                ...
                                <livewire:core.open-modal-button
                                    ...
                                    rounded=true
                                    hasTooltip=true
                                    :tooltip="__('toolTips.person.update')"
                                    icon="edit"
                                    modalTitle="modals.person.actions.update"
                                    :modalTitleOptions="['name' => $p->full_name]"
                                    :modalContent="[
                                ...
                                @canany(['super-admin-access', 'admin-access','social-admin-access'])
                                    <livewire:core.open-modal-button
                                        ...
                                        rounded=true
                                        hasTooltip=true
                                        :tooltip="__('toolTips.person.manage.occupations')"
                                        icon="suitcase"
                                        modalTitle="modals.person.actions.manage.occupations"
                                        :modalTitleOptions="['name' => $p->full_name]"
                                        :modalContent="[
                                    ...
                                    <livewire:core.open-modal-button
                                        wire:key="bank-info-{{ $p->id }}"
                                        rounded=true
                                        hasTooltip=true
                                        :tooltip="__('toolTips.person.manage.banking_information')"
                                        icon="credit_card"
                                    ...
                                    <livewire:core.open-modal-button
                                        wire:key="account-{{ $p->id }}"
                                        rounded=true
                                        hasTooltip=true
                                        :tooltip="__('toolTips.person.manage.account')"
                                        icon="profile"
                                        modalTitle="modals.person.actions.manage.account"
                                        :modalTitleOptions="['name' => $p->full_name]"
                                        :modalContent="[
