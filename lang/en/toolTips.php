...
return [
    ...
    'our_quality' => [
        'update' => 'Update This Quality',
        'delete' => 'Delete This Quality',
    ],
    ...
    "banking_information" => [
        "delete" => "Delete This Banking information",
        "update" => "Update This Banking information"
    ],

    "bank" => [
        "delete" => "Delete This bank",
        "update" => "Update This bank"
    ],

    "menu" => [
        "delete" => "Delete This Menu",
        "update" => "Update This Menu",
        "manage" => "Add External Links"
    ],

    "external_link" => [
        "delete" => "Delete This External Link",
        "update" => "Update This External Link"
    ],
    ...
    "article" => [
        ...
        "update" => "Update This Article"
    ],

    "trend" => [
        "delete" => "Delete This Trend",
        "update" => "Update This Trend"
    ],
    ...
    "global_transfer" => [
        "delete" => "Delete Global Transfer",
        "update" => "Edit Global Transfer",
        "manage" => "Manage Transfer Details"
    ],
